  ...
  return (
    <div className="min-h-[calc(100vh-57px)] bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 px-4 py-8">
      <div className="mx-auto max-w-4xl">
        {/* Welcome header */}
        <div className="rounded-2xl bg-gradient-to-r from-indigo-600/20 to-purple-600/20 border border-indigo-500/30 p-8 backdrop-blur-sm">
          ...
          <div className="mt-6">
            <Link
              href="/play"
              className="inline-flex items-center gap-2 group relative rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-4 text-lg font-bold text-white shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 transition-all duration-200"
            >
        ...
        <div className="mt-8 grid grid-cols-3 gap-4">
          <div className="rounded-xl bg-slate-800/50 border border-indigo-500/20 p-6 text-center backdrop-blur-sm">
            <div className="text-3xl font-bold text-white">{stats.gamesPlayed}</div>
            <div className="mt-1 text-sm text-indigo-300/60">Games Played</div>
          </div>
          <div className="rounded-xl bg-slate-800/50 border border-indigo-500/20 p-6 text-center backdrop-blur-sm">
            <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-green-400">
              {stats.bestScore.toLocaleString()}
            </div>
            <div className="mt-1 text-sm text-indigo-300/60">Best Score</div>
          </div>
          <div className="rounded-xl bg-slate-800/50 border border-indigo-500/20 p-6 text-center backdrop-blur-sm">
            <div className="text-3xl font-bold text-white">
              {stats.avgScore.toLocaleString()}
            </div>
            <div className="mt-1 text-sm text-indigo-300/60">Average Score</div>
          </div>
        </div>
        ...
        {/* Empty state */}
        {games.length === 0 && (
          <div className="mt-8 rounded-xl bg-slate-800/30 border border-indigo-500/20 p-8 text-center">
